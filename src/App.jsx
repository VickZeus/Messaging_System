    ...
    <div className="container">
        ...
        <div className="optionContainer">
              ...
              <div className="option">
                ...
                <i className="material-icons" style={{fontSize:'24px',marginInline:'10px'}}>person</i>
                Find A Friend
                </button>
              </div>
              ...
              <div className="option">
                  <button class='button' onClick={() =>setCurrentPage('history')}>
                    <i className="material-icons" style={{fontSize:'26px',marginInline:'10px'}}>history</i>
                    Chat History
                  </button>
              </div>
              ...
              <div className="option">
                ...
                <i className="material-icons" style={{fontSize:'26px',marginInline:'10px'}}>send</i>
                  Message A Friend
                </button>
              </div>
        </div>
